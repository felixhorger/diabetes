...
struct Parameter
{
	...
	void *content; // TODO: rename to value? shorter and more descriptive
};


struct ParameterList // TODO: replace this with Dictionary below?
{
...
struct Dictionary
{
	...
	size_t valsalloc;
	char *keys;
	void **vals; // TODO: this could also be like keys? Problem is if element is changed an different space required
};
...
void free_parameter(Parameter* p)
{
	...
	else if (is_parameter_type(p, "MeasYaps")) {
		free_measyaps((Dictionary *)p->content);
		free(p->content);
	}
